...
//  unshift()
console.log(fruits.unshift('레몬')); // 2
...
console.log(myStudents); // [ '김일', '김이', '김삼', '김사', '김오', '김육' ]

// slice()
let students = myStudents.slice(2);
console.log(students); // [ '김삼', '김사', '김오', '김육' ]
let students2 = myStudents.slice(3, 5); 
console.log(students2); // [ '김사', '김오' ]
...
/**
 * 점수가 80점이상인 사람만 가지고 새로운 배열을 작성하는 예시
 */
 ...
 * [
  ...
  이상에서 주의할 점은 persons를 가지고 새로운 배열을 만들었는데 persons의 element의 자료형은 object이므로, score들을 가지고 비교했다고 해서 점수들을 element로 삼는 것이 아니라, 새로운 배열인 pass의 element도 여전히 object다. 
 */
